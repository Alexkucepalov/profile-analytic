...
namespace Horizons.Connection
{
    public partial class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("assortment", "public");
            ...
            {
                entity.ToTable("contrpartner", "public");
            ...
            {
                entity.ToTable("sale_document", "public");
            ...
            modelBuilder.HasSequence("contrpartner_sq", "public");
